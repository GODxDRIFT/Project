            ...
            {openChildCategories && (
              ...
              <li>
                <Link
                  ...
                  className={cn(
                    "flex items-center px-4 py-2 text-gray-700 rounded-md hover:bg-blue-50 hover:text-blue-600",
                    isActive("/admin/plan") && "bg-blue-50 text-blue-600"
                  )}
                >
              ...
              <li>
                <Link
                  to="/admin/corporateadvertiseenquiries"
                  className={cn(
                    "flex items-center px-4 py-2 text-gray-700 rounded-md hover:bg-blue-50 hover:text-blue-600",
                    isActive("/admin/corporateadvertiseenquiries") && "bg-blue-50 text-blue-600"
                  )}
                >
                  <MessageSquare className="h-5 w-5 mr-3" />
                  Corporate Advertise Enquiries
                </Link>
              </li>
              ...
              <li>
                <Link
                  ...
                  className={cn(
                    "flex items-center px-4 py-2 text-gray-700 rounded-md hover:bg-blue-50 hover:text-blue-600",
                    isActive("/admin/coupon") && "bg-blue-50 text-blue-600"
                  )}
                >
