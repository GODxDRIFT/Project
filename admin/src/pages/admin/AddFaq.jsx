...
const AddFaq = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await postData('faq/create-faq', formData);
            if (res?.status) {
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="flex items-center space-x-2 mt-2">
                                    <input type="checkbox" id="isActive" name="isActive" checked={formData?.isActive} onChange={handleCheckboxChange} className="h-4 w-4" />
