      ...
      <div className="container text-center">
        <div className="position-relative mt-3">
          ...
          <div className="position-absolute top-0 start-50 translate-middle-x d-none d-md-block">
            <Image
              priority src={curvedDottedLine} alt="Curved Dotted Line" />
          </div>
          ...
          <div className="row justify-content-center">
            {[
              ...
              <div key={index} className="col-md-3 col-6 text-center mb-3">
                <div
                ...
                <h3 className="mt-3 roadmapp-heading">{item.title}</h3>
                <p className="text-muted roadmapp-desc">{item.subtitle}</p>
              </div>
            ))}
          </div>
        </div>
