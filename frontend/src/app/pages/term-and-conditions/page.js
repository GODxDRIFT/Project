      ...
      <div className="py-3 terms-container">
        <div className="container">
          ...
          <div className="terms-main mb-4">
            <p>
              This website (Biziffy.com) is operated by Mediaman Advertising.
              Throughout the site, the terms “we”, “us” and “our” refer to
              Mediaman Advertising offers this website, including all
          ...
          <div className="terms-main mb-4">
            <h4 className="terms-section-title">SECTION 7 - OPTIONAL TOOLS</h4>
            <p>
          ...
          <div className="terms-main mb-4">
            ...
            <p>
              In no case shall Mediaman Advertising, our directors, officers,
          ...
          <div className="terms-main mb-4">
            ...
            <p>
              You agree to indemnify, defend and hold harmless Mediaman
              Advertising and our parent, subsidiaries, affiliates, partners,
          ...
          <div className="terms-main mb-4">
            <h4 className="terms-section-title">SECTION 15 - SEVERABILITY </h4>
            <p>
          ...
          <div className="terms-main mb-4">
            <h4 className="terms-section-title">SECTION 16 - TERMINATION </h4>
            <p>
          ...
          <div className="terms-main mb-4">
            <h4 className="terms-section-title">SECTION 18 - GOVERNING LAW </h4>
            <p>
              These Terms of Service and any separate agreements whereby we
              provide you Services shall be governed by and construed in
              accordance with the laws of India and jurisdiction of Hisar,
              Haryana.
            </p>
          </div>
          <div className="terms-main mb-4">
