...
const page = () => {
  return (
    <>
      <Head>
        <title>Privacy Policy | Biziffy</title>
        <meta
          name="description"
        ...
        <div className="container">
          ...
          <div className="mb-4 terms-main">
            ...
            <p>
              ...
              computers internet protocol (IP) address in order to provide us
          ...
          <div className="mb-4 terms-main">
            <h4 className="terms-section-title">SECTION 2 - CONSENT </h4>
            ...
            <p>
              ...
              support@biziffy.com or mailing us at: Mediaman Advertising, Near
              Jind Chungi, Barwala, Hisar, Haryana.
            </p>
          </div>

          <div className="mb-4 terms-main">
            <h4 className="terms-section-title">SECTION 3 - DISCLOSURE </h4>
            <p>
          ...
          <div className="mb-4 terms-main">
            <h4 className="terms-section-title">SECTION 4 – PAYMENT </h4>
            <p>
          ...
          <div className="mb-4 terms-main">
            <h4 className="terms-section-title">SECTION 6 - SECURITY</h4>
            <p>
          ...
          <div className="mb-4 terms-main">
            <h4 className="terms-section-title">SECTION 7 - COOKIES</h4>
            <p>
          ...
          <div className="mb-4 terms-main">
            <h4 className="terms-section-title">SECTION 8 - AGE OF CONSENT</h4>
            <p>
          ...
          <div className="mb-4 terms-main">
            ...
            <p>
              ...
              Officer at{" "}
              <Link href="mailto:support@biziffy.com">support@biziffy.com</Link>{" "}
              or by mail at Mediaman Advertising, Near Jind Chungi, Barwala,
              Hisar, Haryana. 125121
            </p>
          </div>
          <div className="mb-4 terms-main">
            <p>
              <b>Privacy Compliance Officer:</b> Pardeep Kumar
            </p>
            <p>Near Jind Chungi, Barwala, Hisar, Haryana</p>
            <p>India 125121</p>
          </div>
        </div>
      </div>
